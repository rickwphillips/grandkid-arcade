...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        // is_string before mb_strlen/preg_match: PHP 8 throws an uncaught
        // TypeError on array input, which escapes as a fatal 500 instead of the
        // JSON error envelope every other guard here returns.
